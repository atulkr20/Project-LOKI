...
import { Terminal, User, Mail, Lock, ChevronRight, Cpu, ArrowRight, ShieldCheck } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
          ...
          alert("IDENTITY NODE CREATED. INITIALIZING...");
          navigate('/login');
      }, 1500);
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      {/* --- 1. THE HEADER SECTION (Outside the Box) --- */}
      <div style={styles.brandingSection}>
        {/* The Square Terminal Logo */}
        ...
        <form onSubmit={handleSignup} style={styles.form}>
            ...
            <div style={styles.inputContainer}>
                ...
                <input 
                  ...
                  onChange={handleChange}
                  type="email" 
                  placeholder="COMM_CHANNEL@ADDR.NET"
                  required
                  style={styles.input}
                />
            </div>
            ...
            <button disabled={loading} style={styles.button}>
              ...
              {loading ? "INITIALIZING..." : "CREATE_IDENTITY_NODE"}
            </button>
...
const styles = {
  ...
  input: {
    ...
    outline: 'none',
    letterSpacing: '1px',
    textTransform: 'uppercase', // Matches the "IDENTITY_HANDLE" look
  },
