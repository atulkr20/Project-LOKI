      ...
      >
        ...
        <div className="bg-green-900/30 border-b border-green-600 p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Terminal size={16} />
            <span className="text-xs font-bold tracking-widest">PROJECT LOKI // REGISTER</span>
          </div>
        ...
        <div className="p-8 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2 tracking-wider">Create Account</h2>
          <p className="text-xs text-green-400/70 mb-8">Join the system today</p>

          <form className="w-full flex flex-col items-center space-y-4">
            
            {/* Username */}
            <div className="w-4/5 space-y-1">
              <label className="text-xs font-bold text-green-600 ml-1">Username</label>
              <input 
                type="text" 
            ...
            {/* PHYSICAL SPACER (To force distance) */}
            <div className="h-24 w-full"></div> 

            {/* SIGN UP BUTTON - GREEN & NARROW (text color matches header 'Create Account') */}
            <button id="signup-btn-debug" style={{backgroundColor: '#ffffff', color: '#00ff41'}} className="w-40 bg-green-600 hover:bg-green-500 text-white font-extrabold py-3 transition-all uppercase tracking-widest shadow-[0_0_20px_rgba(0,255,65,0.3)] hover:shadow-[0_0_40px_rgba(0,255,65,0.6)] hover:scale-[1.05] rounded-md text-sm">
              Sign Up
            </button>
          ...
          <div className="mt-8 text-center text-xs opacity-60">
            ...
            <Link to="/login" className="text-green-400 hover:text-white hover:underline ml-1 font-bold">
              Login here
            </Link>
          </div>
