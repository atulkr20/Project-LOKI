...
// CORS CONFIGURATION (The Universal Fix)
// origin: true -> Tells the server to reflect the request origin (Allows everyone)
app.use(
  cors({
    origin: true,
    credentials: true,
...
// This fixes the "404 Preflight" error
app.options("*", cors());
...
app.get("/:shortCode", async (req, res) => {
  // ... (Keep your redirect logic exactly the same) ...
