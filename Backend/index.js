...
const app = express();
// Render sets PORT to 10000. We must use it.
const PORT = process.env.PORT || 8000;

//  MANUAL CORS MIDDLEWARE (The reliable fix)
...
//  Listen on '0.0.0.0' explicitly for Render
app.listen(PORT, '0.0.0.0', () => {
    console.log(`[LOKI]: Server running on PORT ${PORT}`);
});